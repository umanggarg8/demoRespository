...
import fetchLookupData from '@salesforce/apex/lwcCustomLookupController.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/lwcCustomLookupController.fetchDefaultRecord';
...
// allow parent component to set the selected record
 @api updateSelectedRecord(selectedRecordName, selectedRecordld){ 
     this.selectedRecord = {Name: selectedRecordName, Id: selectedRecordld};
     //this.lookupUpdatehandler(this.selectedRecord); // update value on parent component as well 
     this.handelSelectRecordHelper(); // helper function to short/hide lookup result container on 
} 
}